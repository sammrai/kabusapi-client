...
T = TypeVar("T", bound="RequestRegister")
...
class RequestRegister:
    """
    Attributes:
        symbols (list[RequestRegisterSymbolsItem] | Unset):
    """

    symbols: list[RequestRegisterSymbolsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _symbols is not UNSET:
            ...
            for symbols_item_data in _symbols:
                symbols_item = RequestRegisterSymbolsItem.from_dict(symbols_item_data)

                symbols.append(symbols_item)

        request_register = cls(
            symbols=symbols,
        )

        request_register.additional_properties = d
