...
T = TypeVar("T", bound="RequestSendOrderDerivOptionReverseLimitOrder")


@_attrs_define
class RequestSendOrderDerivOptionReverseLimitOrder:
    """逆指値条件<br>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        request_send_order_deriv_option_reverse_limit_order = cls(
        ...
        request_send_order_deriv_option_reverse_limit_order.additional_properties = d
        return request_send_order_deriv_option_reverse_limit_order
