...
T = TypeVar("T", bound="MarginPremiumResponseGeneralMargin")


@_attrs_define
class MarginPremiumResponseGeneralMargin:
    """一般信用（長期）
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        margin_premium_response_general_margin = cls(
        ...
        margin_premium_response_general_margin.additional_properties = d
        return margin_premium_response_general_margin
