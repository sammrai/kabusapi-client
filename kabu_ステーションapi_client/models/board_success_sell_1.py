...
T = TypeVar("T", bound="BoardSuccessSell1")


@_attrs_define
class BoardSuccessSell1:
    """売気配数量1本目
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        board_success_sell_1.additional_properties = d
        return board_success_sell_1
