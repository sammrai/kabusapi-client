...
T = TypeVar("T", bound="株価情報種別7RankingItem")


@_attrs_define
class 株価情報種別7RankingItem:
    """
    Attributes:
        ...
        rapid_payment_percentage (float | Unset): 代金急増（％）
    ...
    rapid_payment_percentage: float | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        rapid_payment_percentage = self.rapid_payment_percentage
        ...
        if rapid_payment_percentage is not UNSET:
            field_dict["RapidPaymentPercentage"] = rapid_payment_percentage
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rapid_payment_percentage = d.pop("RapidPaymentPercentage", UNSET)
        ...
        株価情報種別7_ranking_item = cls(
            ...
            rapid_payment_percentage=rapid_payment_percentage,
            turnover=turnover,
        ...
        株価情報種別7_ranking_item.additional_properties = d
        return 株価情報種別7_ranking_item
