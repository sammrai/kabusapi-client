...
T = TypeVar("T", bound="株価情報種別14RankingItem")


@_attrs_define
class 株価情報種別14RankingItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        株価情報種別14_ranking_item.additional_properties = d
        return 株価情報種別14_ranking_item
