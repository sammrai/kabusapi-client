...
**TickCount** | **number** | TICK回数 | [optional] [default to undefined]
**UpCount** | **number** | UP | [optional] [default to undefined]
**DownCount** | **number** | DOWN | [optional] [default to undefined]
**ChangePercentage** | **number** | 騰落率（%） | [optional] [default to undefined]
**TradingVolume** | **number** | 売買高&lt;br&gt;売買高を千株単位で表示する&lt;br&gt;※百株の位を四捨五入 | [optional] [default to undefined]
...
```typescript
import { RankingByTickCountResponseRankingInner } from 'kabusapi-client';

const instance: RankingByTickCountResponseRankingInner = {
    _false,
    Trend,
    AverageRanking,
    Symbol,
