...
**RapidTradePercentage** | **number** | 売買高急増（％） | [optional] [default to undefined]
...
```typescript
import { RankingByTradeVolumeResponseRankingInner } from 'kabusapi-client';

const instance: RankingByTradeVolumeResponseRankingInner = {
    _false,
    Trend,
    AverageRanking,
    Symbol,
